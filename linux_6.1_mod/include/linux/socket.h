...
#define __CMSG_FIRSTHDR(ctl, len)                                    \
	((len) >= sizeof(struct cmsghdr) ? (struct cmsghdr *)(ctl) : \
					   (struct cmsghdr *)NULL)
...
#define MSG_SENDPAGE_NOPOLICY \
	0x10000 /* sendpage() internal : do no apply policy */
#define MSG_SENDPAGE_NOTLAST \
	0x20000 /* sendpage() internal : not the last page */
#define MSG_BATCH 0x40000 /* sendmmsg(): more messages coming */
#define MSG_EOF MSG_FIN
#define MSG_NO_SHARED_FRAGS \
	0x80000 /* sendpage() internal : page frags are not shared */
