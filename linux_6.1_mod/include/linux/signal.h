...
#define _SIG_SET_BINOP(name, op)                            \
    static inline void name(sigset_t *r, const sigset_t *a, \
                            const sigset_t *b) {            \
...
static inline void disallow_signal(int sig) { kernel_sigaction(sig, SIG_IGN); }
...
#define SIG_KERNEL_STOP_MASK                                           \
    (rt_sigmask(SIGSTOP) | rt_sigmask(SIGTSTP) | rt_sigmask(SIGTTIN) | \
     rt_sigmask(SIGTTOU))
...
#define SIG_KERNEL_IGNORE_MASK                                          \
    (rt_sigmask(SIGCONT) | rt_sigmask(SIGCHLD) | rt_sigmask(SIGWINCH) | \
     rt_sigmask(SIGURG))

#define SIG_SPECIFIC_SICODES_MASK                                     \
    (rt_sigmask(SIGILL) | rt_sigmask(SIGFPE) | rt_sigmask(SIGSEGV) |  \
     rt_sigmask(SIGBUS) | rt_sigmask(SIGTRAP) | rt_sigmask(SIGCHLD) | \
     rt_sigmask(SIGPOLL) | rt_sigmask(SIGSYS) | SIGEMT_MASK)
